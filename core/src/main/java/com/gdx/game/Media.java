...
public class Media {
    ...
    public static final Texture rabite = new Texture("entities/ennemies/rabite.png");
    ...
    public static final Texture rabiteWalkDown = new Texture("entities/ennemies/rabite_walking_down.png");
